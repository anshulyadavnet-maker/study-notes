...
**Q123.** Child fractions 1/8 को 1/6 से बड़ा बताता है क्योंकि 8 बड़ा है। यह किसका संकेत है?
...
```figure
type: strategy-ctet
caption: अलग सही strategies को compare करके mathematical reasoning visible बनाइए
```
...
- A. arrays/groups बनाकर दोनों situations represent कराना
...
- B. उसे careless कहना
- C. decimals हटाना
- D. decimal place chart और money/measurement model से compare कराना
...
- B. अलग orientations में shapes manipulate कराना
- C. केवल definition लिखवाना
- D. child को visual learner label करना

**Answer:** B

**Explanation:** Rotation और varied examples shape properties को appearance से अलग समझाते हैं।
...
- C. measuring grid पर dimensions बदलकर area observe कराना
...
- A. estimation और exact answer का purpose compare कराना
...
- A. symbol को meaning के बिना रटाना चाहिए
...
**Explanation:** Multiple representations symbol को conceptual meaning से जोड़ती हैं।

**Q145.** Community Mathematics activity का visual purpose क्या है?

```figure
type: community-math
caption: market, bus stop, kitchen और playground से Mathematics को daily life से जोड़िए
```
...
caption: teach, observe, diagnose और adapt का feedback loop formative assessment दिखाता है
```
...
caption: child answer से error analyse करके misconception और support plan बनाइए
```
...
**Q187.** Child $1/2+1/3=2/5$ करता है। Teacher को—
...
```figure
type: remedial-cycle
caption: diagnosis के बाद targeted task, guided practice और re-check होना चाहिए
```
