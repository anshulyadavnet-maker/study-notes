...
number: 342
caption: place-value blocks से hundreds, tens और ones की value पहचानिए
```
...
caption: number line पर दाईं ओर स्थित संख्या बड़ी होती है
```
...
**Explanation:** 20 × 6 + 4 × 6 = 120 + 24 = 144।
...
**Explanation:** Equal groups के लिए 7 × 6 = 42।
...
**Explanation:** 19 को 10 + 9 में split करके 7 × 19 = 7 × 10 + 7 × 9।

**Q028.** 2/3 के equivalent fraction कौन-सा है?
...
**Explanation:** Numerator और denominator दोनों को 2 से multiply करने पर 4/6 मिलता है।
...
**Explanation:** 7 ÷ 4 = 1 remainder 3, इसलिए 1 3/4।
...
num: 3
den: 4
caption: numerator shaded parts और denominator total equal parts दिखाता है
```
...
**Explanation:** 3 selected parts out of 4 equal parts = 3/4।
...
```figure
type: shape-symmetry
caption: reflection line के दोनों ओर matching halves symmetry दिखाते हैं
```
...
```figure
type: solid-net-ctet
caption: cube net के छह squares fold होकर cube के छह faces बनाते हैं
```
...
**Explanation:** 3 kg = 3000 g; 3000 + 250 = 3250 g।
...
hour: 3
minute: 30
caption: minute hand at 6 means 30 minutes
```
...
**Explanation:** Area = side² = 9 × 9 = 81 cm²।
...
```figure
type: math-data-ctet
caption: bar height data value को category-wise दिखाती है
```
...
**Explanation:** 4 × 5 = 20 children।

**Q085.** Pattern 2, 4, 6, 8, 10 में next number?

```figure
type: pattern-ctet
caption: growing pattern में हर step का change पहचानिए
```
...
```figure
type: money-ctet
caption: अलग notes/coins को जोड़कर total money निकालिए
```
...
**Q095.** यदि Monday को 4 और Tuesday को 7 books issue हुईं, तो Tuesday को Monday से कितनी अधिक books issue हुईं?
...
**Q096.** Pictograph में key “1 picture = 10 trees” है। 6 pictures क्या दिखाएँगी?
