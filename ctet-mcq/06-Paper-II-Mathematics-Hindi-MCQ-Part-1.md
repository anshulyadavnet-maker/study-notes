...
point: -3
other: 2
caption: compare integer positions on a number line
```
...
**Explanation:** दो negative integers का product positive होता है और 4 × 3 = 12।

---

**Q009.** Calculate कीजिए: (−24) ÷ 6
...
**Explanation:** Negative को positive से divide करने पर answer negative होता है; 24 ÷ 6 = 4।

---

**Q010.** Temperature −3°C है और 8°C बढ़ता है। नया temperature क्या होगा?
...
**Explanation:** Rise का अर्थ 8 जोड़ना है: −3 + 8 = 5°C।
...
**Explanation:** Multiples पहली बार 24 पर मिलते हैं: 8 × 3 = 12 × 2 = 24।
...
**Explanation:** Product = HCF × LCM: 8 × 12 = 4 × LCM, इसलिए LCM = 24।
...
b_num: 6
b_den: 8
caption: equivalent fractions shown with equal whole bars
```
...
**Q024.** 3/5 × 10/9 का simplest form क्या है?
...
**Explanation:** 2/7 से divide करना 7/2 से multiply करने के बराबर है: 4/7 × 7/2 = 2।
...
**Q027.** 0.7, 2/3, 0.65 और 5/8 में सबसे बड़ा कौन-सा है?
...
**Explanation:** 2/3 लगभग 0.667 और 5/8 = 0.625 है; इसलिए 0.7 सबसे बड़ा है।

---

**Q028.** Calculate कीजिए: 1 1/2 + 2 3/4
...
**Explanation:** Fourth में बदलें: 1 1/2 = 1 2/4; sum = 4 1/4।

---

**Q029.** 40 का 3/5 कितना होगा?
...
a: 2
b: 3
caption: equal unit strips show the ratio 2:3
```
...
**Explanation:** एक pen की cost ₹8 है; 8 pens की cost 8 × ₹8 = ₹64।
...
**Explanation:** Scale के अनुसार 7 × 5 = 35 km।
...
**Explanation:** Total parts 5 हैं; one part = 25 ÷ 5 = 5, girls = 3 × 5 = 15।
...
**Explanation:** Total parts 5; one part ₹72, इसलिए छोटा share 2 × ₹72 = ₹144।
...
**Explanation:** Common term b को 10 करें: 4:5 → 8:10, इसलिए a:b:c = 8:10:3।

---

**Q040.** यदि 3/4 = x/20, तो x का value क्या है?
...
value: 4
constant: 3
caption: both sides of an equation must remain balanced
```
...
**Explanation:** Perimeter = 2(length + breadth) = 2(x + 3) = 2x + 6।

---

**Q049.** Pattern 3, 6, 9, 12, … का nth term क्या है?
...
**Explanation:** Position number n को 3 से multiply करने पर nth term 3n मिलता है।
...
caption: a transversal creates related angles on parallel lines
```

**Q051.** जिन दो angles का sum 90° हो, उन्हें कहते हैं—
...
**Explanation:** Complementary angles मिलकर right angle यानी 90° बनाते हैं।

---

**Q052.** जिन दो angles का sum 180° हो, उन्हें कहते हैं—
...
**Explanation:** Supplementary angles का total 180° यानी straight angle होता है।
...
**Q054.** Straight line पर adjacent angles 110° और x° हैं। x क्या होगा?
...
**Explanation:** Straight line के angles का sum 180° होता है; x = 180° − 110° = 70°।

---

**Q055.** Figure में एक corresponding angle 65° है। दूसरी parallel line पर corresponding angle होगा—
...
**Explanation:** Perpendicular lines right angle पर मिलती हैं; प्रत्येक angle 90° का होता है।
...
**Explanation:** Straight angle एक line बनाता है और 180° का होता है।

---

**Q060.** Parallel lines में same-side interior angles में एक 65° है। दूसरा angle होगा—
...
**Explanation:** Same-side interior angles supplementary होते हैं; दूसरा = 180° − 65° = 115°।

---

## Set 07 — Triangles, symmetry और solids (Q061–Q070)

> Triangles और solids को properties, visualisation और construction से जोड़कर समझना चाहिए।

```figure
type: triangle-construction-paper2
caption: compass arcs locate the third vertex of a constructed triangle
```

```figure
type: solid-net-ctet
caption: six square faces form a cube net
```
...
**Explanation:** हर triangle का angle sum 180° होता है।
...
**Explanation:** Hypotenuse 90° angle के opposite होती है और right triangle की longest side होती है।
...
**Explanation:** तीनों angles equal हैं और sum 180° है; प्रत्येक 180° ÷ 3 = 60°।
...
**Explanation:** 120°, 240° और 360° rotation पर figure same दिखाई देती है; order 3 है।
...
caption: AC and BD join opposite vertices of a quadrilateral
```
...
**Explanation:** Quadrilateral को दो triangles में बाँट सकते हैं, इसलिए sum = 2 × 180° = 360°।
...
**Explanation:** Hexagon को 4 triangles में बाँट सकते हैं: 4 × 180° = 720°।
...
**Explanation:** Diagonal opposite vertices को join करती है; AC और BD opposite vertices को join करती हैं।
...
cols: 6
rows: 4
caption: count unit squares to connect area with length and breadth
```
...
**Explanation:** 6 columns और 4 rows के unit squares हैं: area = 6 × 4 = 24 square units।
...
**Q083.** Square का area 64 cm² है। उसकी side होगी—
...
**Explanation:** Side² = 64, इसलिए side = √64 = 8 cm।
...
**Explanation:** Parallelogram area = base × height = 9 × 4 = 36 cm²।
...
**Explanation:** Volume = length × breadth × height = 5 × 4 × 3 = 60 cm³।
...
**Explanation:** Area side² होता है; (2s)² = 4s²।
...
**Explanation:** 1 m = 100 cm, इसलिए 1 m² = 100 × 100 = 10,000 cm²।
...
**Q090.** Rectangle का area 96 cm² और length 12 cm है। Breadth क्या होगी?
...
**Explanation:** Breadth = area ÷ length = 96 ÷ 12 = 8 cm।
...
caption: compare two data sets across the same categories
```
...
**Explanation:** Mean = (4 + 7 + 5 + 8) ÷ 4 = 24 ÷ 4 = 6।
...
**Explanation:** Scale value को height से multiply करें: 6 × 5 = 30।
