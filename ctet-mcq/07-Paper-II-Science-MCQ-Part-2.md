...
> **PYQ-concept based practice:** These original questions cover CTET Paper-II Science pedagogy: nature and aims of science, inquiry, observation, experimentation, integrated approaches, resources, evaluation, misconceptions, inclusion and remedial teaching.
>
...
**Q162.** A learner says a heavy stone falls faster than a light stone in every situation. The teacher should—
...
> **Revision target:** In pedagogy questions, first identify the learner’s idea or evidence, then choose the response that preserves the scientific goal, provides an accessible investigation and uses the result to plan the next step.
