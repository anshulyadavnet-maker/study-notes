...
- B. Find different rectangles with area 24 cm² and explain how you know they work.
...
```figure
type: strategy-ctet
caption: different strategies can lead to the same correct result
```
...
**Q113.** Before teaching operations with integers, a teacher asks learners to discuss gains and losses. This uses—
...
**Q114.** A learner says 1/3 is greater than 1/2 because 3 is greater than 2. The teacher should first—
...
- C. What does the symbol ≤ tell us in this statement, and which values satisfy it?
...
caption: use mathematical evidence to adapt the next teaching step
```
...
caption: trace a wrong answer to the child’s strategy, then plan support
```
...
```figure
type: remedial-cycle
caption: diagnose, target support, practise, re-check and adjust
```
...
```figure
type: community-math
caption: market, transport, kitchen and playground contexts can generate mathematics
```
...
**Q191.** A learner says 1/3 > 1/2 because 3 > 2. Which teacher response is most appropriate?
...
> **Revision target:** For Paper-II pedagogy, practise reading the child’s method before choosing the teacher response. The correct option usually makes thinking visible, uses an appropriate representation, supports participation and turns assessment into the next teaching step.
