...
**Explanation:** The product of two negative integers is positive, and 4 × 3 = 12.
...
**Explanation:** A negative divided by a positive is negative; 24 ÷ 6 = 4.
...
**Explanation:** A rise of 8 means add 8: −3 + 8 = 5°C.
...
**Explanation:** Multiples meet first at 24: 8 × 3 = 12 × 2 = 24.
...
**Explanation:** For positive integers, product = HCF × LCM: 8 × 12 = 4 × LCM, so LCM = 24.
...
**Q024.** What is 3/5 × 10/9 in simplest form?
...
**Explanation:** Cancel 5 with 10 and 3 with 9: (1 × 2)/(1 × 3) = 2/3.

---

**Q025.** What is (4/7) ÷ (2/7)?
...
**Explanation:** Dividing by 2/7 means multiplying by 7/2: 4/7 × 7/2 = 2.
...
**Q027.** Which is the greatest: 0.7, 2/3, 0.65 or 5/8?
...
**Explanation:** 2/3 is about 0.667 and 5/8 is 0.625, so 0.7 is greatest.

---

**Q028.** Calculate: 1 1/2 + 2 3/4
...
**Explanation:** Convert to fourths: 1 1/2 = 1 2/4; then 1 2/4 + 2 3/4 = 4 1/4.

---

**Q029.** What is 3/5 of 40?
...
**Explanation:** Divide both terms by their HCF, 6: 12 ÷ 6 : 18 ÷ 6 = 2:3.
...
**Explanation:** One pen costs ₹8; eight pens cost 8 × ₹8 = ₹64.
...
**Explanation:** Using the scale, 7 × 5 = 35 km.
...
**Explanation:** There are 5 total parts; each part is 25 ÷ 5 = 5, so girls = 3 × 5 = 15.
...
**Explanation:** Total parts = 5; one part = ₹72, so the smaller share is 2 × ₹72 = ₹144.
...
**Q040.** If 3/4 = x/20, then x equals—
...
**Q049.** The nth term of the pattern 3, 6, 9, 12, … is—
...
**Explanation:** The nth term is three times the position number: 3 × n.
...
**Explanation:** Same-side interior angles are supplementary, so the other angle is 180° − 65° = 115°.
...
**Explanation:** All three angles are equal and their sum is 180°; each is 180° ÷ 3 = 60°.
...
**Explanation:** A hexagon is divided into 4 triangles, so its angle sum is 4 × 180° = 720°.
...
**Explanation:** There are 6 columns and 4 rows of unit squares: area = 6 × 4 = 24 square units.
...
**Q083.** A square has area 64 cm². Its side is—
...
**Explanation:** Side² = 64, so side = √64 = 8 cm.
...
**Explanation:** Area of a parallelogram = base × height = 9 × 4 = 36 cm².

---

**Q086.** The volume of a cuboid measuring 5 cm × 4 cm × 3 cm is—
...
**Explanation:** Area is side²; (2s)² = 4s².

---

**Q088.** 1 m² is equal to—
...
**Explanation:** Since 1 m = 100 cm, 1 m² = 100 × 100 = 10,000 cm².
...
**Explanation:** A pentagon has five equal sides, so perimeter = 5 × 7 = 35 cm.

---

**Q090.** A rectangle has area 96 cm² and length 12 cm. Its breadth is—
...
**Explanation:** Multiply the scale value by the bar height: 6 × 5 = 30.
...
> **Revision target:** For content questions, draw a number line, strip, balance, grid or table whenever it clarifies the relationship. Always check units, signs, scale and whether a formula matches the shape.
