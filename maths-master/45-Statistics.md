# अध्याय 45 — सांख्यिकी (Statistics)

## 45.1 :icon-target: परिचय व वेटेज

Statistics data को collect, arrange, represent और interpret करने की mathematics है। Government exams में raw numbers, frequency tables और graphs से mean, median, mode, range और comparison पूछे जाते हैं।
...
|---|---:|---|
| **SSC CGL Tier-1** | **2–3** | mean, median, mode, graphs |
| **SSC CGL Tier-2** | **3–5** | grouped data और DI foundation |
| SSC CHSL / MTS / GD | 1–2 | frequency and average |
| **SSC CPO** | **2** | charts and central tendency |
| **IBPS / SBI PO** | **2–4** | data tables, missing frequency |
| IBPS / SBI Clerk | 2–3 | mean, pie/bar chart |
| **RRB NTPC / ALP** | **2–3** | statistics and graph |
| UP Police SI / Constable | 1–2 | mean/median/mode |
| UPSSSC PET | 1–2 | table and graph reading |
| Super TET / UPTET | 2 | data representation and pedagogy |

> :icon-key: **पूरे अध्याय का एक वाक्य:** Data को पहले order/frequency table में व्यवस्थित करें, फिर central tendency या graph का सही formula चुनें।

---

## 45.2 :icon-number: Data और frequency table
...
## 45.5 :icon-chart: Mode और empirical relation
...
## 45.6 :icon-ruler: Grouped data — class mark और median/mode
...
## 45.7 :icon-chart: Histogram और frequency polygon
...
## 45.8 :icon-list: Bar diagram, pie chart और ogive
...
## 45.9 :icon-divide: Missing frequency और data checks
...
## 45.10 :icon-bulb: Shortcuts और method map
...
## 45.12 :icon-exam: विगत वर्ष प्रश्न (PYQ)

**PYQ 1.** *(SSC CGL)* $8,10,12,15,15$ का mean?

**हल:** $\mathbf{12}$।

**PYQ 2.** *(SSC CHSL)* Ordered data $3,5,6,8,10,12,15,18,20$ का median?

**हल:** $\mathbf{10}$।

**PYQ 3.** *(RRB NTPC)* Frequencies $3,6,12,5,2$ values $10,20,30,40,50$। Mode?

**हल:** $\mathbf{30}$।

**PYQ 4.** *(IBPS Clerk)* Mean 25, median 27। Empirical mode?

**हल:** $3(27)-2(25)=\mathbf{31}$।

**PYQ 5.** *(UP Police SI)* Pie chart में total 200 और category 50। Angle?

**हल:** $\mathbf{90°}$।

**PYQ 6.** *(SSC MTS)* 10 values का mean25; wrong18 को28 से replace करें। Correct mean?

**हल:** $\mathbf{26}$।

---

## 45.13 :icon-pencil: अभ्यास प्रश्न (25 प्रश्न)
...
## 45.14 :icon-trophy: अध्याय का सार
...
> :icon-trophy: **Statistics complete।** Mean, median, mode, frequency tables और सभी प्रमुख statistical diagrams अब एक connected exam system में covered हैं।
>
> **आगे:** Chapter 46 — **Data Interpretation, Caselets, Data Sufficiency, P&C और Probability**।
