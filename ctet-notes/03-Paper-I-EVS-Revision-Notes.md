...
### :icon-exam: Paper I EVS का structure (ढाँचा)
...
::: remember ✔ EVS lens (मुख्य दृष्टि)
...
```figure
type: integrated-evs
caption: one meaningful EVS theme can connect science, society, language and mathematics
```
...
## 2. :icon-tree: Family and Friends (परिवार और मित्र)

```figure
type: family-tree-evs
caption: family tree organises generations and relationships
```
...
::: trap ⚠️ Family trap (परिवार संबंधी जाल)
“सभी families एक जैसी होती हैं” और “घर का काम work नहीं है”—दोनों statements गलत हैं।
:::

---

## 3. :icon-food: Food (भोजन)

```figure
type: food-source-evs
caption: food sources, preparation and culture are connected
```
...
::: remember ✔ Food revision line (भोजन पुनरावृत्ति पंक्ति)
Food = source + component + preparation + habit + health + culture.
:::

---

## 4. :icon-home: Shelter (आश्रय/घर)

```figure
type: house-climate-evs
caption: house design responds to climate, materials and local needs
```
...
## 5. :icon-water: Water (जल)

```figure
type: water-cycle-evs
caption: evaporation, condensation, precipitation and collection form a water cycle
```
...
caption: filtration removes some visible particles but is not the same as disinfection
```
...
::: question 🎯 EVS question prompt (प्रश्न संकेत)
...
## 6. :icon-travel: Travel (यात्रा)

```figure
type: travel-map-evs
caption: a familiar journey can be mapped through route, direction, distance and transport
```
...
## 7. :icon-recycle: Things We Make and Do (हम क्या बनाते और करते हैं)

```figure
type: materials-cycle-evs
caption: trace a material from source to object, use, reuse or recycling
```
...
::: remember ✔ Materials lens (पदार्थ दृष्टि)
...
caption: EVS learning moves from observation to question, record and explanation
```
...
```figure
type: activity-evs
caption: a meaningful EVS activity moves from question to exploration, discussion and reflection
```
...
```figure
type: assessment-evs
caption: EVS assessment uses observation, records, feedback and support to improve learning
```
...
::: formula 🎯 Best EVS response (सर्वोत्तम EVS प्रतिक्रिया)
...
::: formula 🎯 Final EVS rule (अंतिम EVS नियम)
